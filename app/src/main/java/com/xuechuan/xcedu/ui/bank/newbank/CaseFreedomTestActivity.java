 ...
 */
public class CaseFreedomTestActivity extends BaseActivity implements View.OnClickListener, GmReadTwoFragment.notification {
        ...
        if (mDoLogProgressSqliteHelp != null) {
            if (mMainDataLists != null && !mMainDataLists.isEmpty()) {
                final DoLogProgreeSqliteVo look = mDoLogProgressSqliteHelp.findLookWithTidChapterId(
                       mChapter_Id, Integer.parseInt(mCourseId), DataMessageVo.ORDER_THREE);
                if (look == null) return;
